...
inventory.zip is the final project ready for grading. Written in VSCode and relies on XAMPP for MySQL and Apache servers. To run extract the .zip folder into
xampp/htdocs, in browser (your favorite one) type url: http://localhost/inventory, it will redirect you to login page. 
